    ...
    <section id="community">
      ...
      <div className="manifesto-banner assemble delay-2">
        ...
        <div className="manifesto-photos">
          <div className="manifesto-photo"><Image src="/images/vision1.webp" alt="Worker looking at skyline" width={200} height={280} /></div>
          <div className="manifesto-photo"><Image src="/images/vision2.webp" alt="Crew on site" width={200} height={280} /></div>
          <div className="manifesto-photo"><Image src="/images/vision3.webp" alt="Builder at sunrise" width={200} height={280} /></div>
        </div>
      </div>
      ...
      <div className="community-grid">
        ...
        <a href={INSTAGRAM_URL} target="_blank" rel="noopener noreferrer" className="social-card ig-card assemble delay-4">
          <div className="social-icon ig">
            <svg viewBox="0 0 24 24" fill="none" stroke="#E1306C" strokeWidth="1.5" aria-hidden="true">
